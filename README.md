...
The example uses the Node.js 'http' module to run a simple web server. For more information on the 'http' module please refer to the NodeJs documentation - http://nodejs.org/api/http.html
...
- Node.js
  ...
  2. Browse to the directory of the nodejs-qliksense you have just downloaded.
...
- Qlik Sense Server
  ...
  2. Edit the Proxy server settings and ensure to select 'Virtual Procies' from the options on the right.
